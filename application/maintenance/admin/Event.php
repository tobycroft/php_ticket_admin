...
class Event extends Admin
{
    public function index()
    {
        ...
        return ZBuilder::make('table')
            ...
            ->addTopButtons('add')
            ->addRightButtons(['edit', 'detail' => ['href' => url('detail', ['id' => '__id__'])], 'close' => ['title' => '结单', 'icon' => 'fa-check-circle', 'class' => 'btn btn-xs btn-success', 'href' => url('close', ['id' => '__id__']), 'condition' => 'can_close'], 'cancel' => ['title' => '作废', 'icon' => 'fa-trash', 'class' => 'btn btn-xs btn-danger', 'href' => url('cancel', ['id' => '__id__']), 'condition' => 'can_cancel']])
