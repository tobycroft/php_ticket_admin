...
use app\stor\action\ProjectAction;
...
class Project extends Admin
{
    ...
    public function detail($id = null)
    {
        ...
        $materials = ProjectAction::getProjectMaterials($id);
        $materialsHtml = ProjectAction::renderProjectMaterials($materials);
        ...
        return ZBuilder::make('form')
            ...
            ->setExtraHtml($materialsHtml, 'form_top')
            ->setFormData($info)
            ->fetch();
    }
